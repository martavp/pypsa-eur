...
"""
Adds all sector-coupling components to the n, including demand and supply
...
def add_land_transport(n, costs):
    ...
    if options["endogenous_transport"]:
            ...
            n.madd(
                ...
                capital_cost = 1000*(costs.at['Hydrogen fuel cell (passenger cars)', 'investment']*(calculate_annuity(costs.at['Hydrogen fuel cell (passenger cars)', 'lifetime'], 0.07)+costs.at['Hydrogen fuel cell (passenger cars)', 'FOM']/100)),#snakemake.config['costs']['capital_cost']['H2_vehicle'],#bev_charge_efficiency,      #TO DO: annualize  
                p_nom_extendable=True,
...
def apply_time_segmentation(
    ...
    Input:
        ...
        overwrite_time_dependent: (bool) overwrite time dependent data of pypsa n
