...
def add_land_transport(n, costs):
    ...
    if electric_share != 0:
        ...
        if electric_share > 0:
            ...
            n.links.loc[n.links.carrier=="BEV charger", "p_nom"] = p_nom

            if options["v2g"]:
                n.links.loc[n.links.carrier=="V2G", "p_nom_extendable"] = False
                n.links.loc[n.links.carrier=="V2G", "p_nom"] = p_nom
            if options["bev_dsm"]:
                e_nom = (
                    number_cars
                ...
                n.links.loc[n.links.carrier=="battery storage", "p_nom_extendable"] = False
                n.links.loc[n.links.carrier=="V2G", "p_nom"] = p_nom
    ...
    if ice_share != 0:
        ...
        if ice_share > 0:
            ...
            n.links.loc[n.links.carrier=='land transport oil', "p_set"] = ice_share / ice_efficiency * transport[nodes],
    ...
    if fuel_cell_share != 0:
        n.madd(
            ...
            efficiency=  0.01*costs.at['Hydrogen fuel cell (passenger cars)','efficiency'],#snakemake.config['sector']['H2_car_efficiency'],
